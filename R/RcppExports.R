...
bcc_barycentric_cpp <- function(coords, s, origin, tol = 1e-10) {
    .Call(`_FastPotts_bcc_barycentric_cpp`, coords, s, origin, tol)
}
...
spatial_basis_objective_cpp <- function(par, basis_id, basis_weight, gene_index, log_signature, edge_from, edge_to, lambda, regularization, delta, sigma, n_basis, n_cell_types) {
    .Call(`_FastPotts_spatial_basis_objective_cpp`, par, basis_id, basis_weight, gene_index, log_signature, edge_from, edge_to, lambda, regularization, delta, sigma, n_basis, n_cell_types)
}

spatial_basis_predict_cpp <- function(par, basis_id, basis_weight, gene_index, log_signature, n_basis, n_cell_types) {
    .Call(`_FastPotts_spatial_basis_predict_cpp`, par, basis_id, basis_weight, gene_index, log_signature, n_basis, n_cell_types)
}
