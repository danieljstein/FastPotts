...
spatial_basis_objective_cpp <- function(par, basis_id, basis_weight, gene_index, log_signature, edge_from, edge_to, lambda, regularization, delta, sigma, purity, purity_lambda, n_threads, n_basis, n_cell_types) {
    .Call(`_FastPotts_spatial_basis_objective_cpp`, par, basis_id, basis_weight, gene_index, log_signature, edge_from, edge_to, lambda, regularization, delta, sigma, purity, purity_lambda, n_threads, n_basis, n_cell_types)
}
